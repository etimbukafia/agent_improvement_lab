...
if TYPE_CHECKING:
    from enterprise_agent_improvement_lab.storage.ports import AnnotationStore
...
class AnnotationService:
    ...
    def __init__(self, repository: AnnotationStore) -> None:
...
class RegressionCaseGenerator:
    ...
    def case_from_annotation(
        self,
        annotation: HumanAnnotation,
        source_case: EnterpriseEvaluationCase,
        *,
        dataset_id: str,
        dataset_version: str,
    ...
    def dataset_from_annotations(
        ...
        *,
        ...
        cases: list[EnterpriseEvaluationCase] = []
